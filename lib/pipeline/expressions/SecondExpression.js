...
var SecondExpression = module.exports = function SecondExpression() {
	...
	base.call(this);
}, klass = SecondExpression, base = require("./FixedArityExpressionT")(SecondExpression, 1), proto = klass.prototype = Object.create(base.prototype, {constructor: {value: klass}}); //jshint ignore:line
