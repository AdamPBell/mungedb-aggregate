...
var StrcasecmpExpression = module.exports = function StrcasecmpExpression() {
	...
	base.call(this);
}, klass = StrcasecmpExpression, base = require("./FixedArityExpressionT")(StrcasecmpExpression, 2), proto = klass.prototype = Object.create(base.prototype, {constructor:{value:klass}}); //jshint ignore:line
