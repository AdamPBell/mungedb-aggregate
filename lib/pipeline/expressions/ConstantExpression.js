...
var ConstantExpression = module.exports = function ConstantExpression(value){
	...
	this.value = value;
	base.call(this);
}, klass = ConstantExpression, base = require("./FixedArityExpressionT")(ConstantExpression, 1), proto = klass.prototype = Object.create(base.prototype, {constructor:{value:klass}}); //jshint ignore:line
