...
var SizeExpression = module.exports = function SizeExpression() {
	...
	base.call(this);
}, klass = SizeExpression, base = require("./FixedArityExpressionT")(SizeExpression, 1), proto = klass.prototype = Object.create(base.prototype, {constructor:{value:klass}}); //jshint ignore:line
...
proto.evaluateInternal = function evaluateInternal(vars) {
	...
	if (!(array instanceof Array))
		throw new Error("The argument to $size must be an Array, but was of type: " +
			Value.getType(array) + "; uassert code 17124");
	return array.length;
};
