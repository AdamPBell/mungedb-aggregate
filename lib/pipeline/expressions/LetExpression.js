...
}, klass = LetExpression, Expression = require("./Expression"), base = Expression, proto = klass.prototype = Object.create(base.prototype, {constructor:{value:klass}}); //jshint ignore:line
...
klass.parse = function parse(expr, vpsIn){
	...
	for (var varName in varsElem) { //jshint ignore:line
...
proto.optimize = function optimize() {
	...
	for (var id in this._variables) { //jshint ignore:line
