...
var AddExpression = module.exports = function AddExpression(){
	...
	base.call(this);
}, klass = AddExpression, base = require("./VariadicExpressionT")(AddExpression), proto = klass.prototype = Object.create(base.prototype, {constructor:{value:klass}}); //jshint ignore:line
