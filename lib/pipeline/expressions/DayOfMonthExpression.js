...
var DayOfMonthExpression = module.exports = function DayOfMonthExpression() {
	...
	base.call(this);
}, klass = DayOfMonthExpression, base = require("./FixedArityExpressionT")(klass, 1), proto = klass.prototype = Object.create(base.prototype, {constructor: {value: klass}}); //jshint ignore:line
