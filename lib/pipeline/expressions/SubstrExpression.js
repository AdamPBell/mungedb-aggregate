...
var SubstrExpression = module.exports = function SubstrExpression() {
	...
	base.call(this);
}, klass = SubstrExpression, base = require("./FixedArityExpressionT")(klass, 3), proto = klass.prototype = Object.create(base.prototype, {constructor:{value:klass}}); //jshint ignore:line
...
proto.evaluateInternal = function evaluateInternal(vars) {
	...
	if (typeof pLower !== "number")
		throw new Error(this.getOpName() + ":  starting index must be a numeric type (is JSON type " +
			Value.getType(pLower) + "); uassert code 16034");
	if (typeof pLength !== "number")
		throw new Error(this.getOpName() + ":  length must be a numeric type (is JSON type " +
			Value.getType(pLength) + "); uassert code 16035");
