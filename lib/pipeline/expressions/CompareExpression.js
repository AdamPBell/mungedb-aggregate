...
var CompareExpression = module.exports = function CompareExpression(cmpOp) {
	...
	this.cmpOp = cmpOp;
	base.call(this);
}, klass = CompareExpression, base = require("./FixedArityExpressionT")(CompareExpression, 2), proto = klass.prototype = Object.create(base.prototype, {constructor:{value:klass}}); //jshint ignore:line
...
proto.evaluateInternal = function evaluateInternal(vars) {
	...
	if (cmp === 0) { //jshint noempty:false
		//leave as 0
	} else if (cmp < 0) { //jshint noempty:true
		cmp = -1;
	} else if (cmp > 0) {
		cmp = 1;
	}
