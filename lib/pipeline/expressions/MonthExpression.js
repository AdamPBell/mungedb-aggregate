...
var MonthExpression = module.exports = function MonthExpression() {
	...
	base.call(this);
}, klass = MonthExpression, base = require("./FixedArityExpressionT")(MonthExpression, 1), proto = klass.prototype = Object.create(base.prototype, {constructor: {value: klass}}); //jshint ignore:line
