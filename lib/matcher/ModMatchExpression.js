...
var ModMatchExpression = module.exports = function ModMatchExpression(){
	base.call(this);
	this._matchType = "MOD";
}, klass = ModMatchExpression, base = LeafMatchExpression, proto = klass.prototype = Object.create(base.prototype, {constructor:{value:klass}}); //jshint ignore:line
...
proto.debugString = function debugString(level) {
	return this._debugAddSpace(level) +
		this.path() + " mod " + this._divisor + " % x == " + this._remainder +
