...
var MatchDetails = module.exports = function (){
	...
	this.resetOutput();
}, klass = MatchDetails, proto = klass.prototype;
...
proto.toString = function toString(){
	return "loadedRecord: " + this._loadedRecord + " " +
		"elemMatchKeyRequested: " + this._elemMatchKeyRequested + " " +
		"elemMatchKey: " + ( this._elemMatchKey ? this._elemMatchKey : "NONE" ) + " ";
};
